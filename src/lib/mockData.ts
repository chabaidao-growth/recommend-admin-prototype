...
const products: Product[] = [
  ...
  { id: 'prod-taro-boba', spuId: 'CBD1003', name: '芋圆奶茶', category: '原味奶茶', price: 18, status: 'ACTIVE', salesRank: 6, launchRank: 9, accent: 'linear-gradient(135deg, #583e6e 0%, #cfb6f2 100%)' },
  { id: 'prod-black-sugar', spuId: 'CBD1004', name: '黑糖珍珠奶茶', category: '原味奶茶', price: 20, status: 'ACTIVE', salesRank: 3, launchRank: 8, accent: 'linear-gradient(135deg, #4c2e1e 0%, #c98955 100%)' },
  { id: 'prod-grape', spuId: 'CBD2001', name: '多肉葡萄', category: '鲜果茶', price: 21, status: 'ACTIVE', salesRank: 1, launchRank: 6, accent: 'linear-gradient(135deg, #3d2564 0%, #b590f5 100%)' },
  { id: 'prod-super-fruit', spuId: 'CBD2002', name: '超级杯水果茶', category: '鲜果茶', price: 23, status: 'ACTIVE', salesRank: 5, launchRank: 5, accent: 'linear-gradient(135deg, #d46b17 0%, #ffd28d 100%)' },
  { id: 'prod-orange', spuId: 'CBD2003', name: '满杯橙果', category: '鲜果茶', price: 19, status: 'ACTIVE', salesRank: 8, launchRank: 7, accent: 'linear-gradient(135deg, #bb4d10 0%, #ffb54d 100%)' },
  { id: 'prod-watermelon', spuId: 'CBD2004', name: '西瓜啵啵', category: '鲜果茶', price: 19, status: 'INACTIVE', salesRank: 9, launchRank: 4, accent: 'linear-gradient(135deg, #2d8a4b 0%, #9fe4b3 100%)' },
  { id: 'prod-coconut-latte', spuId: 'CBD3001', name: '生椰拿铁', category: '果咖', price: 22, status: 'ACTIVE', salesRank: 7, launchRank: 3, accent: 'linear-gradient(135deg, #3b3129 0%, #c7b29a 100%)' },
  { id: 'prod-americano', spuId: 'CBD3002', name: '美式咖啡', category: '纯茶', price: 16, status: 'ACTIVE', salesRank: 10, launchRank: 12, accent: 'linear-gradient(135deg, #121212 0%, #6b6b6b 100%)' },
  { id: 'prod-oat-latte', spuId: 'CBD3003', name: '燕麦拿铁', category: '鲜奶茶', price: 20, status: 'ACTIVE', salesRank: 11, launchRank: 2, accent: 'linear-gradient(135deg, #87663c 0%, #d9c098 100%)' },
  { id: 'prod-seasonal', spuId: 'CBD4001', name: '当季限定款', category: '奶昔', price: 24, status: 'ACTIVE', salesRank: 12, launchRank: 1, accent: 'linear-gradient(135deg, #c55d16 0%, #ffdf87 100%)' },
  { id: 'prod-set-classic', spuId: 'CBD5001', name: '经典奶茶套餐', category: '套餐', price: 35, status: 'ACTIVE', salesRank: 13, launchRank: 13, accent: 'linear-gradient(135deg, #8b5e3c 0%, #d4a574 100%)' },
  { id: 'prod-set-fruit', spuId: 'CBD5002', name: '果茶下午茶套餐', category: '套餐', price: 38, status: 'ACTIVE', salesRank: 14, launchRank: 14, accent: 'linear-gradient(135deg, #6b8e5a 0%, #b8d4a3 100%)' },
  { id: 'prod-topping-boba', spuId: 'CBD6001', name: '珍珠', category: '小料', price: 3, status: 'ACTIVE', salesRank: 15, launchRank: 15, accent: 'linear-gradient(135deg, #4a3728 0%, #8c6b4f 100%)' },
  { id: 'prod-topping-taro', spuId: 'CBD6002', name: '芋圆', category: '小料', price: 4, status: 'ACTIVE', salesRank: 16, launchRank: 16, accent: 'linear-gradient(135deg, #6b4e8a 0%, #b894d4 100%)' },
]
...
const strategies: Strategy[] = [
  {
    ...
    kind: 'SYSTEM',
    thumbnails: [{ order: 1, url: 'https://picsum.photos/seed/strategy-hot-all/156/54' }],
  ...
  },
  {
    ...
    filterUnavailable: true,
    kind: 'CUSTOM',
    thumbnails: [{ order: 1, url: 'https://picsum.photos/seed/strategy-new-seasonal/156/54' }],
  ...
  },
  {
    ...
    filterUnavailable: true,
    kind: 'CUSTOM',
    thumbnails: [{ order: 1, url: 'https://picsum.photos/seed/strategy-hot-fruit/156/54' }],
    salesDataSource: 'NATIONAL',
  },
]
...
const combinations: Combination[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { id: 'slot-3', strategyId: 'strategy-hot-fruit' },
    ],
  },
  {
    id: 'comb-3',
    ...
    sessionDedup: true,
    slots: [
      { id: 'slot-1', strategyId: 'strategy-hot-fruit' },
      { id: 'slot-2', strategyId: 'strategy-new-seasonal' },
      { id: 'slot-3', strategyId: 'strategy-hot-all' },
    ],
  },
  {
    id: 'comb-4',
    ...
    sessionDedup: true,
    slots: [
      { id: 'slot-1', strategyId: 'strategy-new-seasonal' },
      { id: 'slot-2', strategyId: 'strategy-hot-all' },
      { id: 'slot-3', strategyId: 'strategy-new-seasonal' },
      { id: 'slot-4', strategyId: 'strategy-hot-fruit' },
      { id: 'slot-5', strategyId: 'strategy-new-seasonal' },
      { id: 'slot-6', strategyId: 'strategy-hot-all' },
    ],
  },
  {
    id: 'comb-5',
  ...
  },
  {
    ...
    slots: [
      ...
      { id: 'slot-2', strategyId: 'strategy-hot-fruit' },
      { id: 'slot-3', strategyId: 'strategy-new-seasonal' },
      { id: 'slot-4', strategyId: 'strategy-hot-all' },
      { id: 'slot-5', strategyId: 'strategy-manual-coffee' },
      { id: 'slot-6', strategyId: 'strategy-hot-fruit' },
    ],
  },
  {
    id: 'comb-8',
    ...
    slots: [
      ...
      { id: 'slot-4', strategyId: 'strategy-hot-all' },
      { id: 'slot-5', strategyId: 'strategy-new-seasonal' },
      { id: 'slot-6', strategyId: 'strategy-manual-coffee' },
    ],
  },
]
...
const ROLES: Role[] = [
  {
    ...
    name: '超级管理员',
    code: 'SUPER_ADMIN',
    description: '系统硬编码角色，拥有全部权限（含用户/角色管理），不可删除/编辑',
...
const USERS: User[] = [
  {
    ...
    createdAt: '2026-01-01 10:00',
    createdBy: 'system',
    employeeId: '1000003421',
    jobTitle: '运营平台负责人',
    department: '茶百道/数字化中心/运营产品部',
    reportsTo: '王婧',
  },
  {
    ...
    displayName: '张运营',
    email: 'z***y@chabaidao.com',
    phone: '138****8002',
    roleIds: ['role-operator', 'role-product-ops'],
    status: 'ACTIVE',
    lastLoginAt: '2026-04-19 14:20',
    createdAt: '2026-01-05 10:00',
    createdBy: 'chenyue',
    employeeId: '1000004105',
    jobTitle: '高级运营',
    department: '茶百道/数字化中心/运营产品部',
    reportsTo: '陈悦',
  },
  {
    ...
    createdBy: 'chenyue',
    employeeId: '1000004388',
    jobTitle: '商品运营',
    department: '茶百道/商品中心/选品部',
    reportsTo: '陈悦',
  },
  {
    id: 'user-wangcelue',
    ...
    createdBy: 'chenyue',
    employeeId: '1000004722',
    jobTitle: '策略分析',
    department: '茶百道/数字化中心/算法部',
    reportsTo: '陈悦',
  },
]

export const FEILIAN_DIRECTORY: FeilianProfile[] = [
  {
    displayName: '骆颖',
    employeeId: '1000005777',
    username: 'luoying',
    phone: '158****1075',
    email: 'l***g@chabaidao.com',
    jobTitle: '产品经理岗',
    department: '董事会/数字化中心/增长产品部',
    reportsTo: '王婧',
  },
  {
    displayName: '何旭',
    employeeId: '1000006102',
    username: 'hexu',
    phone: '186****7853',
    email: 'h***u@chabaidao.com',
    jobTitle: '前端工程师',
    department: '茶百道/数字化中心/研发部',
    reportsTo: '高帅',
  },
  {
    displayName: '陈智辉',
    employeeId: '1000006309',
    username: 'chenzhihui',
    phone: '182****2921',
    email: 'c***i@chabaidao.com',
    jobTitle: '商品运营',
    department: '茶百道/商品中心/选品部',
    reportsTo: '李选品',
  },
  {
    displayName: '高帅',
    employeeId: '1000004901',
    username: 'gaoshuai',
    phone: '175****3034',
    email: 'g***i@chabaidao.com',
    jobTitle: '前端 Leader',
    department: '茶百道/数字化中心/研发部',
    reportsTo: '王婧',
  },
  {
    displayName: '刘雨婷',
    employeeId: '1000005512',
    username: 'liuyuting1',
    phone: '135****3878',
    email: 'l***1@chabaidao.com',
    jobTitle: '产品运营',
    department: '茶百道/数字化中心/运营产品部',
    reportsTo: '陈悦',
  },
  {
    displayName: '莫日根',
    employeeId: '1000005188',
    username: 'morigen',
    phone: '136****4376',
    email: 'm***n@chabaidao.com',
    jobTitle: '后端工程师',
    department: '茶百道/数字化中心/研发部',
    reportsTo: '高帅',
  },
